...
Shader "Toony Colors Pro 2/User/Raccoon"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[NoScaleOffset] _WindMask ("Wind Mask Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			Varyings Vertex(Attributes input)
			{
				...
				float3 __windMask = ( input.vertexColor.rrr * TCP2_TEX2D_SAMPLE_LOD(_WindMask, _WindMask, output.pack0.xy, 0).rgb );
...
/* TCP_DATA u config(ver:"2.9.1";unity:"2021.3.4f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","WIND_ANIM_SIN","WIND_ANIM","WIND_SHADER_FEATURE","CRISP_RAMP","RAMP_MAIN_OTHER","RAMP_SEPARATED","WRAPPED_LIGHTING_CUSTOM","TEMPLATE_LWRP","CULLING","BACKFACE_LIGHTING_Z"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[,,,,,sp(name:"Ramp Threshold";imps:list[imp_mp_range(def:0.5;min:0;max:1;prop:"_RampThreshold";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"a2239714-8aad-49f4-abcb-2ddd5f08cb6c";op:Multiply;lbl:"Threshold";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"Ramp Threshold Other Lights";imps:list[imp_mp_range(def:0.5;min:0;max:1;prop:"_RampThresholdOtherLights";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"d732826f-c2ec-4bdd-b72c-c34ff79ab215";op:Multiply;lbl:"Threshold";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,sp(name:"Wind Mask";imps:list[imp_vcolors(cc:3;chan:"RRR";guid:"2500c658-6d92-45dd-a590-3244aba14967";op:Multiply;lbl:"Mask";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:0;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_WindMask";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"9785b529-9072-466a-a8dc-7e98b337acae";op:Multiply;lbl:"Wind Mask Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,,,,,,sp(name:"Face Culling";imps:list[imp_enum(value_type:0;value:2;enum_type:"ToonyColorsPro.ShaderGenerator.Culling";guid:"c9a65352-8f73-4bd1-a812-f03e882bb36b";op:Multiply;lbl:"Face Culling";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 236fb6952962eba77d663f5ce2a70d82 */
